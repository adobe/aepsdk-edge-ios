...
public class LOCALRealNetworkService: NetworkService {
    ...
    public func getNetworkRequestsWith(url: String, httpMethod: HttpMethod, expectationTimeout: TimeInterval = 2, file: StaticString = #file, line: UInt = #line) -> [NetworkRequest] {
    ...
    /// - SeeAlso:
    ///     - ``setExpectationForNetworkRequest(url:httpMethod:expectedCount:file:line:)``
    public func getNetworkRequestsWith(url: URL, httpMethod: HttpMethod, expectationTimeout: TimeInterval = 2, file: StaticString = #file, line: UInt = #line) -> [NetworkRequest] {
