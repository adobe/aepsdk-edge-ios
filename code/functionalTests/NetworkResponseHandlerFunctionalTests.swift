...
class NetworkResponseHandlerFunctionalTests: FunctionalTestBase {
    ...
    func testProcessResponseOnError_WhenEmptyJsonError_doesNotHandleError() {
        ...
        let dispatchEvents = getDispatchedEventsWith(type: FunctionalTestConst.EventType.EXPERIENCE_PLATFORM, source: FunctionalTestConst.EventSource.ERROR_RESPONSE_CONTENT)
    ...
    func testProcessResponseOnError_WhenGenericJsonError_dispatchesEvent() {
        ...
        let jsonError = "{\n" +
            ...
            "\n}"
        networkResponseHandler.processResponseOnError(jsonError: jsonError, requestId: "123")
        let dispatchEvents = getDispatchedEventsWith(type: FunctionalTestConst.EventType.EXPERIENCE_PLATFORM, source: FunctionalTestConst.EventSource.ERROR_RESPONSE_CONTENT, timeout: 5)
    ...
    func testProcessResponseOnSuccess_WhenEmptyJsonResponse_doesNotDispatchEvent() {
        ...
        let dispatchEvents = getDispatchedEventsWith(type: FunctionalTestConst.EventType.EXPERIENCE_PLATFORM,
    ...
    func testProcessResponseOnSuccess_WhenOneEventHandle_dispatchesEvent() {
        ...
        let dispatchEvents = getDispatchedEventsWith(type: FunctionalTestConst.EventType.EXPERIENCE_PLATFORM, source: FunctionalTestConst.EventSource.RESPONSE_CONTENT)
        XCTAssertEqual(1, dispatchEvents.count)
        guard let receivedData = dispatchEvents[0].data else {
            XCTFail("Invalid event data")
            return
    ...
    func testProcessResponseOnSuccess_WhenEventHandleAndError_dispatchesTwoEvents() {
        ...
        let dispatchErrorEvents = getDispatchedEventsWith(type: FunctionalTestConst.EventType.EXPERIENCE_PLATFORM, source: FunctionalTestConst.EventSource.ERROR_RESPONSE_CONTENT)
