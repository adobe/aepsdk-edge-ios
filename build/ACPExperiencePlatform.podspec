...
Pod::Spec.new do |s|
  ...
  s.homepage         = "https://github.com/adobe/ACPExperiencePlatform"
  s.license          = { :type => "Apache License, Version 2.0", :file => "LICENSE" }
  s.author           = "Adobe Experience Platform SDK Team"
  s.source           = { :git => "https://github.com/adobe/ACPExperiencePlatform.git", :tag => "v#{s.version}-#{s.name}" }
  s.platform = :ios, "10.2"
  s.requires_arc = true
  s.static_framework = true
  
  s.dependency "ACPCore", ">=2.6.2"
